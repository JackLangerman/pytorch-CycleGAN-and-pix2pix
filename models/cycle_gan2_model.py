...
class CycleGAN2Model(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            parser.add_argument('--optimizer', type=str, default='adam', help='optimizer to use [adam|lamb default: adam')
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            ...
            self.optimizer_G = Lamb(itertools.chain(self.netG_A.parameters(), self.netG_B.parameters()), 
                    lr=opt.lr, weight_decay=opt.wd, adam=(opt.optimizer=='adam'),
                    betas=(opt.beta1, 0.999))
            self.optimizer_D = Lamb(itertools.chain(self.netD_A.parameters(), self.netD_B.parameters()), 
                    lr=opt.lr, weight_decay=opt.wd, adam=(opt.optimizer=='adam'),
                    betas=(opt.beta1, 0.999))
